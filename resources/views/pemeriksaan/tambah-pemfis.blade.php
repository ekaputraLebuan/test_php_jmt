...
<div class="d-flex flex-column flex-xl-row">
    ...
    <div class="flex-lg-row-fluid ms-lg-15">
        <div class="tab-content">
            <form  method="post" action="/save-pemeriksaan-fisik/{{ $data->id }}">
                @csrf
                    ...
                    <div class="card-body pt-0 pb-5">
                        <div class="row">
                            ...
                            <div class="col-6 mb-5">
                                ...
                                <input id="beratbadan" type="text" name="beratbadan" value="{{ old('beratbadan') }}" 
                            ...
                            <div class="col-6 mb-5">
                                ...
                                <input id="tinggibadan" type="text" name="tinggibadan" value="{{ old('tinggibadan') }}"
                            ...
                            <div class="col-6 mb-5">
                                ...
                                <input id="tekanandarah" type="text" name="tekanandarah" value="{{ old('tekanandarah') }}"
                            ...
                            <div class="col-6 mb-5">
                                ...
                                <input id="nadi" type="text" name="nadi" value="{{ old('nadi') }}"
                            ...
                            <div class="col-6 mb-5">
                                ...
                                <input id="suhutubuh" type="text" name="suhutubuh" value="{{ old('suhutubuh') }}"
                            ...
                            <div class="col-6 mb-5">
                                ...
                                <input id="imt" type="text" name="imt" value="{{ old('imt') }}"
                            ...
                            <div class="col-6 mb-5">
                                ...
                                <input id="saturasioksigen" type="text" name="saturasioksigen" value="{{ old('saturasioksigen') }}"
