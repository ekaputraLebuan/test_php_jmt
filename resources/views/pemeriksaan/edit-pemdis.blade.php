...
<div class="d-flex flex-column flex-xl-row">
    ...
    <div class="flex-lg-row-fluid ms-lg-15">
        <div class="tab-content">
            <form  method="post" action="/update-pemeriksaan-medis/{{ $pemdis->id }}">
                @method('put')
                @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-5">
                                ...
                                class="form-control form-control-sm form-control-solid @error('keluhanutama') is-invalid @enderror" data-kt-autosize="true">
                                    {{ old('keluhanutama', $pemdis->keluhanutama) }}
                                </textarea>
                                @error('keluhanutama')
                            ...
                            <div class="col-12 mb-5">
                                ...
                                class="form-control form-control-sm form-control-solid @error('riwayatapenyakitsekarang') is-invalid @enderror" data-kt-autosize="true">
                                    {{ old('riwayatapenyakitsekarang', $pemdis->riwayatapenyakitsekarang) }}
                                </textarea>
                            ...
                            <div class="col-12 mb-5">
                                ...
                                class="form-control form-control-sm form-control-solid @error('riwayatapenyakitdahulu') is-invalid @enderror" data-kt-autosize="true">
                                    {{ old('riwayatapenyakitdahulu', $pemdis->riwayatapenyakitdahulu) }}
                                </textarea>
                            ...
                            <div class="col-12 mb-5">
                                ...
                                class="form-control form-control-sm form-control-solid @error('riwayatalergi') is-invalid @enderror" data-kt-autosize="true">
                                    {{ old('riwayatalergi', $pemdis->riwayatalergi) }}
                                </textarea>
                                @error('riwayatalergi')
                                    <div class="fv-plugins-message-container invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="col-12 mb-5">
                                ...
                                class="form-control form-control-sm form-control-solid @error('riwayatpemakaianobat') is-invalid @enderror" data-kt-autosize="true">
                                    {{ old('riwayatpemakaianobat', $pemdis->riwayatpemakaianobat) }}
                                </textarea>
                            ...
                            <div class="col-12 mb-5">
                                ...
                                <input id="diagnosautama" type="text" name="diagnosautama" value="{{ old('diagnosautama', $pemdis->diagnosautama) }}"
                            ...
                            <div class="col-12 mb-5">
                                ...
                                <input id="diagnosatambahan" type="text" name="diagnosatambahan" value="{{ old('diagnosatambahan', $pemdis->diagnosatambahan) }}"
