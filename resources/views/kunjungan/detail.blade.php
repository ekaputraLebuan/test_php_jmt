    ...
    <div class="card-body pt-9 pb-0">
        ...
        <div class="d-flex overflow-auto h-55px">
            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
                <li class="nav-item">
                    <a class="nav-link text-active-primary me-6 active" data-bs-toggle="tab" href="#pemFis">Pemeriksaan Fisik</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-active-primary me-6" data-bs-toggle="tab" href="#pemDIs">Pemeriksaan Medis</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-active-primary me-6" data-bs-toggle="tab" href="#resep">Resep</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="card  mb-5 mb-xl-10">
    <div class="card-body pt-5 pb-6">
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="pemFis" role="tabpanel">
                @if(!$pemfis)
                    <div class="d-flex justify-content-between align-items-center">
                        <span class="text-gray-600 fw-bolder">Belum Ada Pemeriksaan <span class="text-danger">!!!</span></span> 
                        @can('perawat')
                            <a href="/tambah-pemeriksaan-fisik/{{ $data->id }}" class="btn btn-sm btn-light-info">
                ...
                @else
                    <div class="text-end">
                        @can('perawat')
                            <a href="/edit-pemeriksaan-fisik/{{ $pemfis->id }}" class="btn btn-sm btn-light-success">
                                <i class="fas fa-pencil-alt"></i> Ubah Pemeriksaan
                            </a>
                        @endcan
                    </div>
                    ...
                    <table class="table table-row-dashed table-row-gray-300 gy-7">
                        ...
                        <tbody>
                            <tr>
                                <td>Berat Badan</td>
                                <td>{{ $pemfis->beratbadan }}</td>
                                <td>Kg</td>
                            </tr>
                            <tr>
                                <td>Tinggi Badan</td>
                                <td>{{ $pemfis->tinggibadan }}</td>
                                <td>cm</td>
                            </tr>
                            <tr>
                                <td>Tekana Darah</td>
                                <td>{{ $pemfis->tekanandarah }}</td>
                                <td>mmHg</td>
                            </tr>
                            <tr>
                                <td>Nadi</td>
                            ...
                            <tr>
                                <td>Suhu</td>
                                <td>{{ $pemfis->suhutubuh }}</td>
                                <td>°C</td>
                            </tr>

                            <tr>
                                <td>saturasioksigen</td>
                                <td>{{ $pemfis->saturasioksigen }}</td>
                                <td>x/menit</td>
                            </tr>
                            <tr>
                                <td>IMT</td>
            ...
            <div class="tab-pane fade" id="pemDIs" role="tabpanel">
                @if(!$pemdis)
                <div class="d-flex justify-content-between align-items-center">
                    <span class="text-gray-600 fw-bolder">Belum Ada Pemeriksaan <span class="text-danger">!!!</span></span> 
                    @can('dokter')
                        <a href="/tambah-pemeriksaan-medis/{{ $data->id }}" class="btn btn-sm btn-light-info">
                            <i class="fas fa-notes-medical"></i> Input Pemeriksaan
                        </a>
                    @endcan
                </div>
                @else
                    <div class="text-end">
                        @can('dokter')
                        <a href="/edit-pemeriksaan-medis/{{ $pemdis->id }}" class="btn btn-sm btn-light-success">
                            <i class="fas fa-pencil-alt"></i> Ubah Pemeriksaan
                        </a>
                         @endcan
                    </div>
                    <div class="mb-3">
                        <label for="keluhanutama" class="form-label fw-bolder fs-7">Keluhan Utama</label>
                    ...
                    <div class="mb-3">
                        <label for="keluhanutama" class="form-label fw-bolder fs-7">Riwayat Penyakit Sekarang</label>
                        <p class="text-gray-600 fs-7">
                            {{ $pemdis->riwayatapenyakitsekarang }}
                        </p>
                    </div>

                    <div class="mb-3">
                        <label for="riwayatapenyakitdahulu" class="form-label fw-bolder fs-7">Riwayat Penyakit Dahulu</label>
                        <p class="text-gray-600 fs-7">
                            {{ $pemdis->riwayatapenyakitdahulu }}
                        </p>
                    </div>

                    <div class="mb-3">
                        <label for="riwayatalergi" class="form-label fw-bolder fs-7">Riwayat Alergi</label>
                        <p class="text-gray-600 fs-7">
                            {{ $pemdis->riwayatalergi }}
                        </p>
                    </div>

                    <div class="mb-3">
                        <label for="riwayatpemakaianobat" class="form-label fw-bolder fs-7">Riwayat Pemakaian Obat</label>
                        <p class="text-gray-600 fs-7">
                            {{ $pemdis->riwayatpemakaianobat }}
                        </p>
                    </div>

                    <div class="mb-3">
                        <label for="diagnosautama" class="form-label fw-bolder fs-7">Diagnosa Utama</label>
                        <p class="text-gray-600 fs-7">
                            {{ $pemdis->diagnosautama }}
                        </p>
                    </div>

                    <div class="mb-3">
                        <label for="diagnosatambahan" class="form-label fw-bolder fs-7">Diagnosa Tambahan</label>
                        <p class="text-gray-600 fs-7">
                            {{ $pemdis->diagnosatambahan }}
                        </p>
                    </div>
                @endif
            </div>
            ...
            <div class="tab-pane fade" id="resep" role="tabpanel">
                @if(count($resep) <= 0)
                <div class="d-flex justify-content-between align-items-center">
                    <span class="text-gray-600 fw-bolder">Belum Ada Resep <span class="text-danger">!!!</span></span> 
                    @can('apoteker')
                    <a href="/tambah-resep/{{ $data->id }}" class="btn btn-sm btn-light-info">
                        <i class="fas fa-notes-medical"></i> Input Resep
                    </a>
                    @endcan
                </div>
                @else
                    <table id="tableData" class="table table-row-bordered gy-5" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->obat->namaobat }}</td>
                                <td class="text-center">{{ $item->aturanpakai }}</td>
